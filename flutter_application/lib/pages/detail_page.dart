import 'package:flutter_application/cells/detail_cell.dart';
...
class DetailPage extends StatefulWidget {
  ...
  const DetailPage({Key key, @required this.provider}) : super(key: key);
          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              child: AspectRatio(
                aspectRatio: 196 / 285,
                child: Hero(
                  tag: widget.provider.firstName + widget.provider.lastName,
                  child: Image(
                    filterQuality: FilterQuality.high,
                    fit: BoxFit.fitHeight,
                    image: AssetImage('assets/images/' + widget.provider.image),
                  ),
                ),
              ),
            ),
